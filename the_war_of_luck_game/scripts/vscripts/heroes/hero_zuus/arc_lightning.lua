	...
	-- Waits on the jump delay
		...
		if ability.jump_count[current] > 0 then
			...
			if new_target ~= nil then
				...
				ParticleManager:CreateParticle("particles/skills/wraith_lightning/wraith_lightning_smoke.vpcf",1,new_target)
				...
				ability:ApplyDataDrivenModifier(caster, new_target, "modifier_Wraith Lightning_buff", {})
			else
...
function NewInstance(keys)
    ...
    ParticleManager:CreateParticle("particles/skills/wraith_lightning/wraith_lightning_smoke.vpcf",1,target)
end
